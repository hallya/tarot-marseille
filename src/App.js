  ...
  render() {
    return (
      <div className="App">
        ...
        <Route exact path={process.env.PUBLIC_URL + '/arcanes'} render={() => <Arcanes
        ...
        />
        <Route exact path={process.env.PUBLIC_URL + '/alliance'} render={() => <Alliance
          handleUser={this.handleUser}
          majors={this.state.majors}
          minors={this.state.minors}
          state={this.state}
          ...
          secondSetHouses={[this.state.m13, this.state.m14]}/>}
        />
        <Route exact path={process.env.PUBLIC_URL + '/miroirs-13'} render={() => <Miroirs
          miroirs={this.state.miroir13}
          majors={this.state.majors} />}
        />
        <Route exact path={process.env.PUBLIC_URL + '/miroirs-17'} render={() => <Miroirs
          miroirs={this.state.miroir17}
          majors={this.state.majors} />}
        />
        <Route exact path={process.env.PUBLIC_URL + '/miroirs-22'} render={() => <Miroirs
          miroirs={this.state.miroir22}
          majors={this.state.majors} />}
        />
        <Route exact path={process.env.PUBLIC_URL + '/voies-boucles'} render={() => <VoiesBoucles
          voies={this.state.voies}
          boucles={this.state.boucles}/>}
        />
        <Route exact path={process.env.PUBLIC_URL + '/annees-personnelles'} render={() => <Annees
